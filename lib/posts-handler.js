  ...
  switch (req.method) {
    ...
    case 'POST':
      ...
      req.on('data', (chunk) => {
        ...
        const Programming = dataArray[0] ? dataArray[0].split('Language=')[2] : '';
        const Language = dataArray[0] ? dataArray[0].split('Language=')[3] : '';
        const Experience = dataArray[0] ? dataArray[0].split('Experience=')[4] : '';
        const Communication = dataArray[0] ? dataArray[0].split('Communication=')[5] : '';
        const Judgement = dataArray[0] ? dataArray[0].split('Judgement=')[6] : '';
